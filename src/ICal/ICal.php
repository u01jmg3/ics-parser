...
class ICal
{
     ...
     *
     * @param  string|null $rangeStartS
     * @param  string|null $rangeEndS
     * @return array
     * @throws \Exception
     */
    public function eventsFromRange($rangeStartS = null, $rangeEndS = null)
    {
        ...
        if ($rangeStartS !== null) {
            try {
                $rangeStart = new \DateTime($rangeStartS, new \DateTimeZone($this->defaultTimeZone));
            } catch (\Exception $e) {
                error_log("ICal::eventsFromRange: Invalid date passed ({$rangeStartS})");
                $rangeStart = false;
            }
        } else {
        ...
        if ($rangeEndS !== null) {
            try {
                $rangeEnd = new \DateTime($rangeEndS, new \DateTimeZone($this->defaultTimeZone));
            } catch (\Exception $e) {
                error_log("ICal::eventsFromRange: Invalid date passed ({$rangeEndS})");
                $rangeEnd = false;
            }
        } else {

...
| `$verifySsl`                   | :heavy_multiplication_x: | `true`                                                                                    | Holds the settings to enable or disable SSL peer verification                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `initUrl`                                       | `$url`, `$username = null`, `$password = null`, `$userAgent = null`, `$acceptLanguage = null`, `$httpProtocolVersion = null`, `$verifySsl = true` | `public`    | Initialises lines from a URL. Accepts a username/password combination for HTTP basic authentication, a custom User Agent string, the accepted client language, the HTTP protocol version and control SSL verification behaviour |
